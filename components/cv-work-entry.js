    ...
    const template = `
      ...
      <div class="work-entry">
        <div class="entry-header">
          ${role ? `<div class="role"><strong>${role}</strong>${type ? `<span class="type-badge">${type}</span>` : ""}</div>` : ""}
          <div class="company-line">
            <div class="company-left"><h3 class="company">${company}</h3>${location ? `<span class="location">, ${location}</span>` : ""}</div>
